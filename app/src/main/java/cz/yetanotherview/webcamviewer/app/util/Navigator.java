...
package cz.yetanotherview.webcamviewer.app.util;
...
public class Navigator {
     ...
     */
    public void setRootFragment(final Fragment startFragment, final int id, final String title){
        if(getSize() > 0){
            this.clearHistory();
        }
        this.replaceFragment(startFragment, id, title);
    }
     ...
     */
    private void replaceFragment(final Fragment fragment, final int id, final String title) {
